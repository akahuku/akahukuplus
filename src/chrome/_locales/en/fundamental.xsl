...
.twitter-inner-frame {
	...
	<body>
		<header id="header">
			...
			<div id="header-trail">
				<div>
					<a class="js" href="#toggle-catalog"><kbd>c</kbd><span>Catalog</span></a>
					<xsl:if test="$page_mode='reply'"><a class="js" href="#autotrack">Autotrack</a><a class="js" href="#autosave">Autosave</a></xsl:if>
					<a id="checked-posts" class="js dropdown hide" href="#action-to"><span></span> posts</a>
					<span><small>About </small><span id="viewers" data-binding="xpath:/futaba/meta/viewers">?</span><small> are watching.</small></span>
					<span id="eval-stat" class="hide">Evaluating (<span></span>/<span></span>).</span>
				</div>
				<div>
					<a href="{meta/home}" target="_top">Home</a>
					<xsl:if test="meta/board_top"><a href="{meta/board_top}">Board Top</a></xsl:if>
					<a class="js" href="#toggle-panel"><kbd>p</kbd>Panel</a>
					<a class="js" href="#config">Config</a>
					<a class="js" href="#help"><kbd>?</kbd></a>
					<a class="js dropdown" href="#coin"><span class="coin-image">-</span><span data-binding="coin:#total"></span><small>Coins</small></a>
				</div>
			</div>
		</header>
		...
		<div class="hide" id="catalog">
			<div class="page-mode-header catalog-mode">Catalog mode</div>
			<div class="catalog-options">
				<div>
					<span><a  class="catalog-order js {substring('active',1,6*number($sort_order='default'))}" href="#catalog-order-default">Catalog</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='new'    ))}" href="#catalog-order-new">New</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='old'    ))}" href="#catalog-order-old">Old</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='most'   ))}" href="#catalog-order-most">Much</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='less'   ))}" href="#catalog-order-less">Few</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='trend'  ))}" href="#catalog-order-trend">Active</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='sodane' ))}" href="#catalog-order-sodane">So damn</a></span
					><span><a class="catalog-order js {substring('active',1,6*number($sort_order='hist'   ))}" href="#catalog-order-hist">History</a></span>
				</div>
				<div>
					<span>
						<label>W: <input id="catalog-horz-number" type="text"/></label>
						× <label>H: <input id="catalog-vert-number" type="text"/> threads</label>
					</span
					...
					</xsl:element>with thread text</label></span><span><a class="js" href="#save-catalog-settings">save</a></span>
				</div>
			</div>
		...
		<footer id="footer">
			<div class="reload-image"><a href="#reload" title="Reload"></a></div>
			<div class="credit">—
		...
		<div id="panel-aside-wrap">
			...
			<div class="panel-tab-wrap">
				<a class="panel-tab active" href="#mark"><kbd>s</kbd><span class="short">Stats</span><span class="long">Stats</span></a>
				<a class="panel-tab" href="#search"><kbd>/</kbd><span class="short">Search</span><span class="long">Search</span></a>
				<a class="panel-tab" href="#notice"><kbd>n</kbd><span class="short">Notices</span><span class="long">Notices</span></a>
			</div>
			<div id="panel-content-mark" class="panel-content-wrap">
				<h2>Statistics of the marks</h2>
				<ul>
					<li class="hide"><p>Admin <span data-href="#select"></span></p><div id="stat-admin"></div></li>
					<li class="hide"><p>Nar <span data-href="#select"></span></p><div id="stat-nar"></div></li>
					<li class="hide"><p>Deleted by the thread owner <span data-href="#select"></span></p><div id="stat-passive"></div></li>
					<li class="hide"><p>Deleted by the poster <span data-href="#select"></span></p><div id="stat-active"></div></li>
					<li class="hide"><p>Marked by delete request <span data-href="#select"></span></p><div id="stat-isolated"></div></li>
					<li class="hide"><p>Other red marks <span data-href="#select"></span></p><div id="stat-other"></div></li>
				</ul>
				<h2>Statistics of IDs<span id="stat-id-header"></span></h2>
				<ul id="stat-id"></ul>
			</div>
			<div id="panel-content-search" class="panel-content-wrap hide">
				...
				<div id="search-guide">
					<b>Query syntax:</b>
					<ul>
						<li>A B ─ Searches for posts that contains both A and B. This takes precedence over “|”.</li>
						<li>A | B ─ Searches for posts that contains either A or B.</li>
						<li>-A ─ Searches for posts not containing A</li>
						<li>( A ) ─ Group expression A</li>
					</ul>
					<p>Upper/Lower cases are considered identical.</p>
					<p>If enclosed in “/”, considered a regular expression.</p>
				</div>
		...
		<div id="postform-wrap">
			...
			<div class="postform">
				<div class="status">
				<xsl:choose>
					<xsl:when test="$page_mode='reply'">Reply posting mode</xsl:when>
					<xsl:otherwise>Create new thread</xsl:otherwise>
				</xsl:choose>
				</div>
				<form id="postform" action="{meta/postform/@action}" method="{meta/postform/@method}" enctype="{meta/postform/@enctype}">
					...
					<xsl:for-each select="meta/postform/input[@type='hidden']">
						...
						<tr>
							<th>Comment</th>
							<td>
								<div class="comment-wrap"><textarea name="com" id="com2" resize="false" /><div id="com" contenteditable="plaintext-only" spellcheck="false" data-placeholder="Shift+Enter to post"></div></div>
								<div class="comment-info flex">
									<div id="comment-info-summary">Comment is too long!</div>
								...
								<tr>
									...
									<td>
										<div class="flex">
											...
											<div class="draw-button-wrap bracket hide">[<a href="#draw">Tegaki</a>]</div>
											<div><label>[<input type="checkbox" id="textonly" name="textonly" value="on" data-href="#clear-upfile"/>No attach]</label></div>
										</div>
									</td>
								</tr>
							</xsl:when>
								...
								<tr>
									...
									<td>
										<div class="flex">
											...
											<span id="js-upfile-wrap-nocoin" class="file grow-item">(To attach files, you need 🪙 coins)</span>
											<div class="draw-button-wrap bracket hide">[<a href="#draw">Tegaki</a>]</div>
											<div class="bracket"><label>[<input type="checkbox" id="textonly" name="textonly" value="on" data-href="#clear-upfile"/>No attach]</label></div>
										</div>
									</td>
								</tr>
							</xsl:otherwise>
			...
			<div class="nav">
				<div class="nav-normal" id="nav-normal">
					...
					<div class="tips">
						<a class="js" href="#prev-summary"><kbd>z</kbd>Prev</a>
						&#160; <a class="js" href="#next-summary"><kbd>.</kbd>Next</a>
						&#160; <a class="js" href="#reload"><kbd>r</kbd>Reload</a>
						<kbd>i</kbd>Open post form
					</div>
					</xsl:if>
					<xsl:if test="$page_mode='reply'">
					<div class="status">
						<span id="pf-replies-total">-</span><small> replies</small>,
						<span id="pf-replies-mark">-</span><small> marks</small>,
						<span id="pf-replies-id">-</span><small> IDs</small>
						/ expires at <span id="pf-expires" data-binding="xpath:/futaba/thread[1]/topic/expires"></span>&#160;<small>(<span id="pf-expires-remains" data-binding="xpath:/futaba/thread[1]/topic/expires/@remains"></span>)</small>
					</div>
					<div class="tips">
						<kbd>i</kbd>Open post form
					</div>
			...
			<div class="post-image-thumbnail-wrap hide" id="post-image-thumbnail-wrap">
				<div class="post-image-thumbnail-outer" id="post-image-thumbnail-outer">
					...
					<div id="post-image-thumbnail-info">
						<div></div>
						<div>
							<label title="Remove EXIF when uploading JPEG/PNG"><xsl:element name="input">
								<xsl:attribute name="id">post-image-unexif</xsl:attribute>
								<xsl:attribute name="type">checkbox</xsl:attribute>
								<xsl:if test="meta/configurations/param[@name='strip_exif']/@value='1'">
									<xsl:attribute name="checked">checked</xsl:attribute>
								</xsl:if>
								</xsl:element>Remove EXIF</label>
								<label title="Randomize image hash on JPEG/PNG upload"><input id="post-image-randomize" type="checkbox"/>Randomize<span data-binding="coin:(image_randomize)"></span></label>
							<a class="js" href="#clear-upfile">Cancel attaching</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="selection-menu" class="hide">
			<a class="selmenu l" href="#ss-quote">Quote</a>
			<a class="selmenu l" href="#ss-pull">Copy to comment</a>
			<a class="selmenu l" href="#ss-join">Dai!Kuu!Ji!</a>
			<div class="menu-rule"/>
			<a class="selmenu l" href="#ss-copy">Copy</a>
			<a class="selmenu l" href="#ss-copy-with-quote">Copy with quote</a>
			<div class="menu-rule"/>
			...
			<div class="menu-rule"/>
			<a class="selmenu l" href="#ss-cancel" title="Cancel">Cancel</a>
		</div>
			...
			<div class="receiver">
				<div class="info">
					...
					<div id="lightbox-zoom-modes" class="flex">
						<a class="js" href="#lightbox-whole"><kbd>O</kbd>Whole</a>
						<a class="js" href="#lightbox-actual-size"><kbd>A</kbd>1x</a>
						<a class="js" href="#lightbox-fit-to-width"><kbd>W</kbd>Width</a>
						<a class="js" href="#lightbox-fit-to-height"><kbd>H</kbd>Height</a>
					</div>
					<div id="lightbox-rotate-modes" class="flex">
						<a class="js" href="#lightbox-normal"><kbd>n</kbd>As is</a>
						<a class="js" href="#lightbox-left"><kbd>l</kbd>↶90°</a>
						<a class="js" href="#lightbox-right"><kbd>r</kbd>↷90°</a>
						<a class="js" href="#lightbox-180"><kbd>v</kbd>↺180°</a>
					</div>
					<div class="flex">
						<a class="js" href="#lightbox-search"><kbd>s</kbd>Search</a>
					</div>
					<div class="flex">
						<a class="js" href="#lightbox-copy"><kbd>c</kbd>Copy</a>
					</div>
					<div class="flex">
						<a class="js" href="#lightbox-close"><kbd>esc</kbd>Close</a>
					</div>
				</div>
			</div>
		</div>
		<div id="dialog-wrap" class="dialog-wrap hide">
			...
			<div class="dialog-content-wrap">
				<div>
					<div class="dialog-content-title">Title</div>
					<div class="dialog-content" id="dialog-content"></div>
					<div class="dialog-content-footer"><a href="#apply-dialog">Apply</a><a href="#ok-dialog"><kbd>&#x23ce;</kbd>OK</a><a href="#cancel-dialog"><kbd>esc</kbd>Cancel</a></div>
...
<!--<xsl:if test="$page_mode='reply'">
<div class="page-mode-header reply-mode">Reply posting mode</div>
</xsl:if>-->
<article class="{$page_mode}">
	...
	<div class="image" style="max-width:{topic/thumb/@width}px">
		<div>
			...
			<br/><span class="info-sup"><xsl:value-of select="topic/image/@size"/><xsl:if test="topic/image/@animated"> - Animation GIF</xsl:if></span>
			<br/><a class="save-image" href="{topic/image}">Save to...</a>
		</div>
	</div>
	</xsl:if>
	<div class="text">
		<div class="topic-wrap" data-number="{topic/number}">
			<div>
				...
				<a class="postno" href="#quote">No.<xsl:apply-templates select="topic/number"/></a>&#160;<a class="del js" href="#del">del</a>&#160;<a class="{topic/sodane/@class} js" href="#sodane"><xsl:value-of select="topic/sodane"/></a>&#160;<xsl:if test="$page_mode!='reply'"><span class="reply-link"><a href="{@url}" target="_blank">Reply</a></span></xsl:if>
			</div>
			...
			<xsl:if test="$page_mode='summary' and replies/@hidden>0"><div class="hidden-indicator"><xsl:value-of select="replies/@hidden"/> replies are ommited. Click the Reply button to view.</div></xsl:if>
		</div>
		<div class="replies">
		...
		<xsl:choose>
			...
			<xsl:value-of select="replies/@total"/> replies / expires at <xsl:value-of select="topic/expires"/>&#160;<small>(<xsl:value-of select="topic/expires/@remains"/>)</small>
			<xsl:apply-templates select="topic/expires" mode="simple"/>
			</xsl:when>
			<xsl:when test="$page_mode='reply'">
			<div id="replies-info">
				<div>
					<span id="replies-total">-</span><small> replies</small>,
					<span id="replies-mark">-</span><small> marks</small>,
					<span id="replies-id">-</span><small> IDs</small>
					/ expires at <span id="expires" data-binding="xpath:/futaba/thread[1]/topic/expires"></span>&#160;<small>(<span id="expires-remains" data-binding="xpath:/futaba/thread[1]/topic/expires/@remains"></span>)</small>
				</div>
				<xsl:apply-templates select="topic/expires" mode="simple"/>
				<div class="reloader-wrap">
					<a class="reloader js" href="#reload" id="reload-anchor"><kbd>r</kbd>Read more</a>
		...
		<xsl:if test="image">
			<div class="reply-image">
				...
				<div>
					...
					<xsl:if test="image/@animated"> - Animation GIF</xsl:if>
					<br/><a class="save-image" href="{image}">Save to...</a>
				</div>
			</div>
		</xsl:if>
...
<tr>
	...
	<td>
		...
		<small>(for deletion, Up to 8 alphanumeric characters)</small>
	</td>
</tr>
</xsl:template>
...
<div class="{@class}" data-thumbnail-href="{@thumbnail}">
	...
	<div><a class="save-image" href="{@href}">Save to...</a></div>
</div>
</xsl:when>
...
<small class="inline-save-image-wrap"><a class="save-image" href="{@href}">Save to...</a></small><br/>
...
>This thread will expire at <span data-binding="xpath[reply]:/futaba/thread[1]/topic/expires"><xsl:value-of select="."/></span>.</div>
</xsl:template>
...
>The number of replies has been reached the limit, posting is no longer possible.</div>
<div
	class="{concat('expire-warn ',substring('hide',1,4-count(@warned)*4))}"
	data-binding="xpath-class[reply]:concat('expire-warn ',substring('hide',1,4-count(/futaba/thread[1]/topic/expires/@warned)*4))"
>This thread is old and will be gone soon.</div>
</xsl:template>
