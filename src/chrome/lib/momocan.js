	...
	<div class="toolbox">
		...
		<div>
			...
			<div class="draw-method-wrap">
				<div class="draw-method-list-wrap">
					<a href="#draw-method" data-key="pen" data-index="0" title="ペン (P)"><img src="//dev.appsweets.net/momo/pen.svg"></a>
					<a href="#draw-method" data-key="eraser" data-index="1" title="消しゴム (E)"><img src="//dev.appsweets.net/momo/erase.svg"></a>
					<a href="#draw-method" data-key="bucket" data-index="2" title="バケツ (G)"><img src="//dev.appsweets.net/momo/paint-bucket.svg"></a>

					<a href="#draw-method" data-key="select" data-index="3" title="矩形選択 (M)"><img src="//dev.appsweets.net/momo/select.svg"></a>
					<a href="#draw-method" data-key="lasso" data-index="4" title="なげなわ (L)"><img src="//dev.appsweets.net/momo/lasso.svg"></a>
					<a href="#draw-method" data-key="move" data-index="5" title="移動 (V)"><img src="//dev.appsweets.net/momo/move.svg"></a>
				</div>
				<div class="draw-method-options-wrap">
					<div class="draw-method-options" data-target-method="pen">
						<div class="primary">
							<div class="main">
								...
								<a class="incdec" href="#decrement" title="細くする (Ctrlクリックで微調整)"><img src="//dev.appsweets.net/momo/minus.svg"></a><input class="pen-size-range" type="range" min="1" max="24" step="1"><a class="incdec" href="#increment" title="太くする (Ctrlクリックで微調整)"><img src="//dev.appsweets.net/momo/plus.svg"></a>
					...
					<div class="draw-method-options" data-target-method="eraser">
						<div class="primary">
							<div class="main">
								<div class="head">サイズ:</div>
								<a class="incdec" href="#decrement"><img src="//dev.appsweets.net/momo/minus.svg"></a><input class="eraser-size-range" type="range" min="1" max="24" step="1"><a class="incdec" href="#increment"><img src="//dev.appsweets.net/momo/plus.svg"></a>
					...
					<div class="draw-method-options" data-target-method="bucket">
						...
						<div class="secondary hide">
							<div class="main">
								...
								<a class="incdec" href="#decrement"><img src="//dev.appsweets.net/momo/minus.svg"></a><input class="closed-color-threshold-range" type="range" min="0" max="0.5" step="any"><a class="incdec" href="#increment"><img src="//dev.appsweets.net/momo/plus.svg"></a><span class="output closed-color-threshold-text">0.50</span>
								<div class="head">塗る範囲のはみ出し量:</div>
								<a class="incdec" href="#decrement"><img src="//dev.appsweets.net/momo/minus.svg"></a><input class="overfill-size-range" type="range" min="0" max="10" step="0.1"><a class="incdec" href="#increment"><img src="//dev.appsweets.net/momo/plus.svg"></a><span class="output overfill-size-text">0</span>
							</div>
						</div>
					</div>
		...
		<div class="draw-tools">
			...
			<div class="draw-tools-wrap">
				<div>
					<a href="#draw-undo" data-title="アンドゥ (Ctrl+Z)"><img src="//dev.appsweets.net/momo/undo.svg"></a>
					<a href="#draw-redo" data-title="リドゥ (Ctrl+Y)"><img class="flipx" src="//dev.appsweets.net/momo/undo.svg"></a>
					<a href="#draw-tool" data-type="rotate_left" data-title="キャンバスを左に回転"><img src="//dev.appsweets.net/momo/rotate-left.svg"></a>
					<a href="#draw-tool" data-type="rotate_right" data-title="キャンバスを右に回転"><img class="flipx" src="//dev.appsweets.net/momo/rotate-left.svg"></a>
					<a href="#draw-settings-open" data-title="設定..."><img src="//dev.appsweets.net/momo/settings-gears.svg"></a>

					<a href="#draw-tool" data-type="flip_horizontally" data-title="水平方向に反転"><img src="//dev.appsweets.net/momo/flip-horizontally.svg"></a>
					<a href="#draw-tool" data-type="flip_vertically" data-title="垂直方向に反転"><img src="//dev.appsweets.net/momo/flip-vertically.svg"></a>
					<a href="#draw-tool" data-type="merge_layers" data-title="全レイヤーを背景に集約" class="multi"><img src="//dev.appsweets.net/momo/merge.svg"></a>
					<a href="#draw-tool" data-type="resize" data-title="キャンバスの大きさ..." class="multi"><img src="//dev.appsweets.net/momo/resize.svg"></a>
				</div>
				<div>
					<a href="#draw-tool" data-type="init_canvas" data-title="キャンバスを初期化" class="multi"><img src="//dev.appsweets.net/momo/momo.svg"></a>
				</div>
			</div>
		</div>
	</div>
...
(function () {
	...
	function loadStyle (url) {
		return new Promise((resolve, reject) => {
			...
			link.rel = 'stylesheet';
			link.type = 'text/css';
			link.href = url || `//dev.appsweets.net/momo/can.php?extension=css&timestamp=${interval}`;
	...
	if (/^https?:\/\/[^.]+\.2chan\.net\//.test(window.location.href)) {
		...
		if (typeof chrome != 'undefined' && chrome.runtime && chrome.runtime.id && window.Akahuku) {
